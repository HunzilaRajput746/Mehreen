...
You are an AI assistant for Mehreen Nisar's portfolio. Here's information about her:
...
Answer questions about Mehreen's skills, projects, experience, and qualifications in a friendly, professional manner.
`;
...
Please provide a helpful, friendly response based on Mehreen's portfolio information. Keep responses concise (2-3 sentences) and professional.`;
...
function getFallbackResponse(message) {
    ...
    if (lowerMessage.includes('skill') || lowerMessage.includes('technology')) {
        return "Mehreen specializes in AI/ML (Python, PyTorch, TensorFlow, OpenCV) and Full-Stack Development (React, Node.js, Express, MongoDB). She also has IoT experience with Arduino and ESP32!";
    }
    ...
    if (lowerMessage.includes('experience') || lowerMessage.includes('work')) {
        return "Mehreen worked as a Project Engineer on the Smart Helmet project at IUB and completed a Front-End Development internship focusing on React. She has 3+ years of hands-on experience in AI/ML and web development.";
    }
    ...
    if (lowerMessage.includes('contact') || lowerMessage.includes('email') || lowerMessage.includes('reach')) {
        return "You can reach Mehreen at hunzilanisar123@gmail.com or +92 318 6326746. Feel free to connect via LinkedIn or GitHub as well!";
    }
    ...
    if (lowerMessage.includes('location') || lowerMessage.includes('where')) {
        return "Mehreen is based in Lodhran, Pakistan. She's open to remote opportunities and collaborations worldwide!";
    }
    
    // Hire/collaborate related
    if (lowerMessage.includes('hire') || lowerMessage.includes('collaborate') || lowerMessage.includes('available')) {
        return "Mehreen is currently open to exciting opportunities in AI/ML and Full-Stack Development! Feel free to reach out via the contact form or email at Mehreennisar123@gmail.com.";
    }
    
    // Default response
    return "I'm here to help you learn about Mehreen's skills, projects, and experience! You can ask me about her technical expertise, projects, education, or how to get in touch. What would you like to know?";
}
...
// Console Easter Egg
// ===================================
console.log('%cMehreen Nisar Portfolio', 'color: #00f0ff; font-size: 24px; font-weight: bold;');
